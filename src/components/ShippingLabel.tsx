        ...
        >
            ...
            <div className="flex justify-between items-start border-b border-slate-800 pb-1">
                <div className="text-right">
                    {companyName
                        ...
                        : <div className="font-bold text-slate-400 leading-tight">اسم الشركة</div>
                    }
                    <div className="text-slate-400 mt-0.5">بوليصة شحن</div>
                </div>
            ...
            <div className="grid grid-cols-2 gap-2 border-b border-dashed border-slate-300 pb-1 mt-1">
                ...
                <div className="space-y-0.5">
                    ...
                    <div className="font-bold" dir="ltr">{order.primaryPhone}</div>
                    {order.secondaryPhone && (
                        <>
                            <div className="text-slate-500 mt-0.5">رقم إضافي</div>
                            <div className="text-slate-600" dir="ltr">{order.secondaryPhone}</div>
                        </>
                    )}
                </div>
            </div>
            ...
            <div className="border-b border-dashed border-slate-300 pb-1 mt-1 flex gap-3">
                ...
                <div className="flex-1">
                    <div className="text-slate-500 mb-0.5">العنوان التفصيلي</div>
                    <div className="text-slate-700 leading-snug">{order.shipping?.detailedAddress || '—'}</div>
                </div>
            </div>
                    ...
                    <div className="space-y-0.5 overflow-y-auto max-h-[75px] pr-1">
                        {products.map((p: any, i: number) => (
                            <div key={i} className="flex justify-between">
                                ...
                                <span className="text-slate-500 mr-1">× {p.quantity}</span>
                            </div>
                        ))}
                    </div>
                </div>
